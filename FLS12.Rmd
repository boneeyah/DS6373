...
```
```{r}
busi <- read.csv("https://raw.githubusercontent.com/boneeyah/DS6373/main/businesssales.csv")
...
var2_pred <- predict(VAR2_fit,n.ahead = 5)
var3_pred  <- predict(VAR3_fit,n.ahead = 5)
```
```{r}
x <- 96:100
...
```{r}
plot(1:100,busi$sales,type='l')
points(x,var2_pred$fcst$sales[,1],col='blue',type = 'o')
```

```{r}
plot(1:100,busi$sales,type='l')
points(x,var3_pred$fcst$sales[,1],col='pink',type='o')
```
